...
engine_stmt = 'mysql+mysqlconnector://%s:%s@%s:3306/%s' % ('root', 'ops011260910', 'localhost', 'r6_leaderboard_database')
...
# engine = create_engine('mysql+mysqlconnector://[root]:[ops011260910]@[localhost]:[3306]/[r6_leaderboard_database]', echo=False)
#
...
#     print(x)
#
# mydb = pymysql.connect(host="localhost", port=3306, user="root", passwd="ops011260910", db="r6_leaderboard_database")
#
...
# conn = pymysql.connect(host="localhost", port=3306, user="root", passwd="ops011260910", db="r6_leaderboard_database")
# try:
